...
const Hero = ({ setSignInOpen }) => {
  return (
    <Container id="home">
      <Left>
        <TitleTag><b>Organize. Plan. Succeed.</b></TitleTag>
<DescriptiveTag>Stay ahead of deadlines and manage your work with ease. This simple yet powerful tool is built to help you stay focused and achieve your goals efficiently.</DescriptiveTag>
